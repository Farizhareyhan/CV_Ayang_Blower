...
<head>
  ...
  <!-- Tambahan CSS untuk kartu simetris -->
  <style>
    .card-img-top {
        height: 250px;
        object-fit: cover;
...
<nav class="navbar navbar-expand-lg bg-dark">
  <div class="container">
    <a class="navbar-brand text-white" href="user.php"><strong>CV</strong> Ayang Blower</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a class="nav-link mr-4" href="menu_pembeli.php">DAFTAR PRODUK DEKORASI</a></li>
      ...
      <div class="col-md-4 mb-4">
        <div class="card card-produk">
          ...
          <div class="card-body text-center">
            ...
            <a href="produk-detail.php?id_menu=<?php echo $produk['id_menu']; ?>" class="btn btn-primary text-white">Lihat Detail</a>
          </div>
        </div>
      </div>
    <?php endforeach; ?>
